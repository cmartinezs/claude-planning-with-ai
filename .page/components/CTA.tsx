    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-5xl font-extrabold text-surface-50 mb-6 text-balance">
          Planifica mejor. Construye más rápido.{' '}
          <span className="gradient-text">Con Claude Code.</span>
        </h2>
        <p className="text-lg text-surface-400 max-w-2xl mx-auto mb-10">
          Planning with AI transforma la forma en que Claude Code aborda
          proyectos complejos. Estructura, claridad y trazabilidad en cada paso.
        </p>
