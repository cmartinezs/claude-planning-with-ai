      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-surface-50 leading-tight mb-6 animate-slide-up">
            Planificación
            <br />
            <span className="gradient-text">estructurada</span> para
            <br />
            tu software
          </h1>

          <p className="text-lg sm:text-xl text-surface-400 max-w-2xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: '0.15s' }}>
            Desde la idea inicial hasta el archivo del proyecto. Un sistema completo
            de ciclo de vida que transforma la forma en que planificas con{' '}
            <span className="text-surface-200 font-medium">Claude Code</span>.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.3s' }}>
            ...
            <a href="#que-hace" className="btn-secondary text-base px-8 py-4">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.45s' }}>
            {[
