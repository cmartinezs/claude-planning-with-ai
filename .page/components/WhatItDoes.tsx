const features = [
  {
    ...
    description: 'plan-init detecta la estructura de tu repositorio y configura las áreas de trazabilidad automáticamente.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Añade criterios de aceptación, notas técnicas, dependencias y complejidad a tus historias.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Al completar, se audita y archiva todo el plan en finished/ con trazabilidad completa.',
  },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="section-title mb-4">
            ¿Qué hace{' '}
            <span className="gradient-text">Planning with AI</span>?
          </h2>
          <p className="section-subtitle">
            Un plugin que trae planificación estructurada a Claude Code.
            Desde la chispa inicial hasta el archivo del proyecto.
          </p>
        </div>
