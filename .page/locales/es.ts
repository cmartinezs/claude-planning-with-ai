    ...
    cards: [
      {
        ...
        description: 'Consulta los 44 comandos con argumentos, comportamiento, fuente y casos de uso.',
        href: '/commands',
      ...
      },
      {
        ...
        description: 'Elige el recorrido correcto: desde epic, desde cero, backlog, ajustes o agentes autónomos.',
        href: '/tutorials',
      ...
      },
      {
        ...
        description: '8 escenarios interactivos para practicar el plugin paso a paso, desde básico hasta avanzado.',
        href: '/training',
