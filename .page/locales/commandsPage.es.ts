  ...
  categories: [
    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          description: 'Genera matrices determinísticas de set de pruebas.',
          details: [
            'Escribe artefactos TEST-SUITE a nivel de planning, story o task.',
            'Detecta tooling del repositorio antes de usar guía generada por AI.',
            'Cubre unitarias, coverage, integración, aceptación, análisis estático, estilo, arquitectura, smoke, seguridad y mutación.',
          ],
    ...
    },
    {
      ...
      commands: [
        ...
        {
          name: '/plan-decision',
          usage: '/plan-decision <NNN-slug> -- <título decisión> | <NNN-slug> pdr-NNN-título',
          description: 'Crea o actualiza un Project Decision Record.',
          details: [
            'Escribe PDRs solo para decisiones aceptadas o propuestas que afectan varias stories, áreas, terminología o workflows futuros.',
            'Usa PDR-TEMPLATE.md y preserva nombres de PDR existentes cuando actualiza.',
            'Mantiene decisiones rutinarias de tarea en las notas de diseño en vez de crear registros placeholder.',
          ],
    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          details: [
            'Incluye objetivo, avance de stories, riesgos, métricas, decisiones técnicas, duración y siguientes pasos.',
            'Sirve para comunicar estado fuera del equipo técnico.',
            'Con --metrics, incluye tasa de completitud, bloqueos, promedio de tareas, distribución de riesgos y cobertura de issues.',
          ],
        ...
        },
        {
          ...
          details: [
            'Puede generar descripción de PR, lista de tickets, borrador de issue externo o markdown standalone.',
            'Soporta formatos de borrador para GitHub issue, Jira y Linear.',
        ...
        },
        {
          ...
          description: 'Audita un checkout del plugin o una plantilla instalada.',
          details: [
            'Revisa archivos requeridos, metadata de skills, inventario de comandos, grupos de workflows y markers de templates.',
            'Puede ejecutar scripts/verify-plugin.sh cuando existe.',
    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          description: 'Audita documentación generada o modificada por un planning.',
          details: [
            'Revisa docs esperados, links locales, trazabilidad, frescura y referencias a issues externos.',
            'Lee outputs esperados desde stories, tareas y done criteria.',
            'Es de solo lectura y sirve antes de handoff o archivo.',
          ],
