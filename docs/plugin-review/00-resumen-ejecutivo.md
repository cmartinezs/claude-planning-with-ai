...
3. La documentación pública debe mantenerse alineada con los 50 comandos reales existentes en `skills/`.
...
7. La mejor mejora de alto impacto sería consolidar vocabulario, completar la referencia de comandos, y estandarizar pruebas de humo por stack junto con un modo explícito de proyecto: `software`, `general`, `docs`, `research`, `operations` o similar.
