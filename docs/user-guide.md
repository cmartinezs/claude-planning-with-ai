...
- **Use `/plan-update-version <from> <to>` for old workspaces.** For example, `/plan-update-version 2.1.0 3.10.1` updates a `2.x` workspace to the current baseline using `.planning/update-version/2-3.md`.
